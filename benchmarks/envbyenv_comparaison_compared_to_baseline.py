...
CSV_PATH = "som-rs-5546.csv"

GLOBAL_OUT_ROOT = "output4-without-tinystr"
ENV_OUT_ROOT = "output4-without-tinystr/envs"
SUMMARY_ROOT = "output4-without-tinystr/summaries"
